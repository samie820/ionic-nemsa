...
UploadModalPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["n" /* Component */])({
        selector: 'page-upload-modal',template:/*ion-inline-start:"/home/samuel/Documents/test/devdacticImageUpload/src/pages/upload-modal/upload-modal.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-buttons start>\n      <button ion-button icon-only (click)="dismiss()"><ion-icon name="close"></ion-icon></button>\n    </ion-buttons>\n    <ion-title>Upload Image</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <img [src]="imageData" style="width: 100%">\n  <ion-item>\n    <ion-input placeholder="My Awesome Image" [(ngModel)]="desc"></ion-input>\n  </ion-item>\n\n  <button ion-button full icon-left (click)="saveImage()">\n          <ion-icon name="checkmark"></ion-icon>\n          Save & Upload Image\n  </button>\n</ion-content>'/*ion-inline-end:"/home/samuel/Documents/test/devdacticImageUpload/src/pages/upload-modal/upload-modal.html"*/,
    }),
